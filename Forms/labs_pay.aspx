<%@ Page Title="" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/Reception.Master" CodeBehind="labs_pay.aspx.vb" Inherits="CLOUD_HIMS.labs_pay" %>
            ...
            CellPadding="7" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal">
                ...
                <Columns> 
                    ...
                    <asp:BoundField DataField="count"
                        HeaderText="Requests" SortExpression="count"  ReadOnly="true">
