<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/admin_master.Master" CodeBehind="SetupDiagnosis.aspx.vb" Inherits="CLOUD_HIMS.SetupDiagnosis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                   ...
                   <table style=" margin-left: 5px;  margin-top: 0px;border-style:outset">
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:TextBox ID="txtdiagnosis" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                           <asp:TextBox ID="txtdiagnosiscode" runat="server"></asp:TextBox>                  
                                                       </td>    
                                            </tr>
    ...
    <div style="width:100%;height:50px">
          <div style="width:30%;float:left;">
               <h2 style="padding-left:20px">DIAGNOSIS SETUP</h2>
          </div>
          ...
          <div id="filter" runat="server">               
              ...
              <asp:GridView ID="Grdnewpatients" runat="server" AutoGenerateColumns="False" style="border-style:inset;background-color:transparent;margin-top:10px"
                        EnableViewState="False" BorderColor="#E7E7FF" DataKeyNames="id"
                           CellPadding="6" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" Width="645px">
                               ...
                               <Columns> 
                                   ...
                                   <asp:BoundField DataField="coldiagnosis"
                                       HeaderText="Diagnosis" SortExpression="coldiagnosis" ItemStyle-Width="150" ReadOnly="false">
                                         <ItemStyle Width="150px" Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Middle" />
                                          </asp:BoundField> 

                                       <asp:BoundField DataField="coldiagnosiscode"
                                       HeaderText="Diagnosis Code" SortExpression="coldiagnosiscode" ItemStyle-Width="150" ReadOnly="false">
                                         <ItemStyle Width="150px" Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Middle" />
                                          </asp:BoundField>    

                                     <asp:BoundField DataField="colicd"
                                       HeaderText="ICD-10" SortExpression="colicd" ItemStyle-Width="150" ReadOnly="false">
