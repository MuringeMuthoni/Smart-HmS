<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/admin_master.Master" CodeBehind="SetupVisitType.aspx.vb" Inherits="CLOUD_HIMS.SetupVisitType" %>
                   ...
                   <table style=" margin-left: 5px;  margin-top: 0px;border-style:outset">
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:TextBox ID="txtclinicnames" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
