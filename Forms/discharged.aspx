<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/Reception.Master" CodeBehind="discharged.aspx.vb" Inherits="CLOUD_HIMS.discharged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width:100%;height:50px">
          <div style="width:30%;float:left;">
               <h2 style="padding-left:20px">DISCHARGE LIST</h2>
          </div>
          ...
          <div  style="float:right;text-align:right;width:68%;" >
              <div style="margin-right:20px;margin-top:5px">
                 ...
                 <%-- <asp:Button ID="Btnreport" CssClass="bttns" runat="server" Text="All Patients" BackColor="#FF9900" ForeColor="#000066"  /> --%>
