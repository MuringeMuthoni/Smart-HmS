<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/Reception.Master" CodeBehind="queue.aspx.vb" Inherits="CLOUD_HIMS.queue" %>
                   ...
                   <%-- <asp:UpdatePanel ID="UpdatePanel2"  runat="server">
                            <ContentTemplate>  --%>
                                <div style="margin-top:10px;margin-left:20px; margin-bottom: 0px;">
                                    ...
                                    <asp:DropDownList ID="cbonames" runat="server"  Width="274px" Height="25px">                                      
                                    </asp:DropDownList>
    ...
    <div style="width:100%;height:50px">
          ...
          <div  style="float:right;text-align:right;width:68%;" >
              <div style="margin-right:20px;margin-top:5px">
                  <input id="bttnreceive" type="button" value="Add to Queue" class="bttns" onclick="ReceiveFunds()"  />&nbsp;&nbsp
    ...
    <div id="dmains" style="margin-left:10px;margin-right:10px;width:98%;background-color:white;overflow:scroll">
           <div id="nodata" runat="server" visible="false" style="width:98%;margin-top:50px">   
                 <div style="text-align:left;margin-left:100px">                                                               
                         <h2>   Whoops!   </h2>
                         <p>  No patient awaiting service     </p>
                  </div>   
