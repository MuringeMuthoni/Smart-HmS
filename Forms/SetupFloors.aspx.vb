Public Class SetupFloors
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        lblmsg.Text = ""
        If txtfloorname.Text = "" Then
            lblmsg.Text = "Please enter the Floor's Name before you proceed."
            Exit Sub
        Else
            lblmsg.Text = ""
        End If
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                Tcmd.CommandText = "select id from tbl_setupfloor where colfloorname='" & txtfloorname.Text & "'"
                ...
                Using Mydata
                    If Not Mydata.Read Then
                        ...
                        Tcmd.CommandText = "select count(id) from tbl_setupfloor" ' where colnames='" & txtnames.Text & "' and colid='" & Txtpatientid.Text & "'"
                        Mydata = Tcmd.ExecuteReader()
                        Using Mydata
                            If Mydata.Read Then
                        ...
                        Using cmd
                            ...
                            cmd.CommandText = "INSERT INTO tbl_setupfloor" &
                            "(colfloorname,coldescription)" _
                           & "VALUES(?1,?2)"
                            cmd.Parameters.AddWithValue("?1", txtfloorname.Text)
                    ...
                    Else
                        lblmsg.Text = "Another Floor with same name exists "
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                If txtsnames.Text = "" Then
                    sts = "Select id,colfloorname,coldescription from tbl_setupfloor "
                Else
                    sts = "Select id,colfloorname,coldescription from tbl_setupfloor where colfloorname like '%" & txtsnames.Text & "' order by colfloorname desc"
                End If
