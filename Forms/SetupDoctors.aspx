<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/admin_master.Master" CodeBehind="SetupDoctors.aspx.vb" Inherits="CLOUD_HIMS.SetupDoctors" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                   ...
                   <table style=" margin-left: 5px;  margin-top: 0px;border-style:outset">
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:TextBox ID="txtdoctorsname" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                           <asp:TextBox ID="txtspecialist" runat="server"></asp:TextBox>                  
                                                       </td>    
                                            </tr>
    ...
    <div style="width:100%;height:50px">
          <div style="width:30%;float:left;">
               <h2 style="padding-left:20px">DOCTOR SETUP</h2>
          </div>
          ...
          <div id="filter" runat="server">               
                                <table style="border: 1px inset antiquewhite; background-color:silver;width:600px; margin-left: 10px;  margin-top: 0px;">
                                        ...
                                        <tr style="border-style:inset">
                                             <td style="text-align: right; height: 1px; width: 90px;">
                                                      Doctor Name:
                                              </td>
                           ...
                           CellPadding="6" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal">
                               ...
                               <Columns> 
                                   ...
                                   <asp:BoundField DataField="docname"
                                       HeaderText="Names" SortExpression="docname" ItemStyle-Width="150" ReadOnly="false">
                                         <ItemStyle Width="150px" Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Middle" />
                                          </asp:BoundField> 

                                       <asp:BoundField DataField="colspecialist"
                                       HeaderText="Specialist" SortExpression="colspecialist" ItemStyle-Width="150" ReadOnly="false">
                                         <ItemStyle Width="150px" Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Middle" />
                                          </asp:BoundField>    
                                     ...
                                     <asp:BoundField DataField="colemail"
                                       HeaderText="Email " SortExpression="colemail" ItemStyle-Width="100" ReadOnly="false">
                                         <ItemStyle  Font-Size="Small" HorizontalAlign="Right" VerticalAlign="Middle" />
                                          </asp:BoundField>       
