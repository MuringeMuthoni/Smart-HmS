<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/doctors.Master" CodeBehind="queue_doctors.aspx.vb" Inherits="CLOUD_HIMS.queue_doctors" %>
   ...
   <div id="dmains" style="margin-left:10px;margin-right:10px;width:98%;background-color:white;overflow:scroll">
        ...
        <div >
            <%-- <div style="margin-top:2px;margin-left:5px;">
                                    <asp:Button Text="PATIENT MEDICAL HISTORY" ID="Btnmedicalrecords"  CssClass="bttns_tabs_active"   runat="server"
                                           Onclick="Btnmedicalrecords_Click"     width="350px" Height="30px"  /> 

                                            <asp:Button Text="CURRENT TREATMENT"  ID="BtnConsultation"  CssClass="bttns_tabs_inactive"   runat="server"
                                                OnClick="BtnConsultation_Click"  width="350px" Height="30px" />  
                ...
                <div id="filter" runat="server">               
                                <table style="border: 1px inset antiquewhite; background-color:silver;width:600px; margin-left: 10px;  margin-top: 0px;">
                                        ...
                                        <tr style="border-style:inset">
                                             <td style="text-align: right; height: 1px; width: 50px;">
                                                        Names:
                                              </td>

                                              <td style="text-align: left; height: 1px;width:120px;">
                                                <asp:TextBox ID="txtnames" runat="server"></asp:TextBox>
                                                <asp:Button ID="Btnsearch" runat="server" Text="go" />
                                                </td>

                                                        <td style="text-align: right; height: 1px; width: 27px; ">
                                                            Tel:
                                                             </td>
                                                            <td style="text-align: left; height: 1px; width: 120px">
                    ...
                    <asp:View ID="View1" runat="server">
                        <div id="nodata" runat="server" visible="false" style="width:98%;margin-top:50px">   
                             <div style="text-align:left;margin-left:100px">                                                               
                                     <h2>   Whoops!   </h2>
                                     <p>  No patient awaiting your service currently    </p>
                              </div>   
                    ...
                    <asp:GridView ID="GridView0" runat="server" AutoGenerateColumns="False" style="border-style:inset;background-color:transparent;margin-top:10px"
                     ...
                     <asp:View ID="View2" runat="server" >
                          ...
                          <div id="nodata2" runat="server" visible="false" style="width:98%;margin-top:50px">   
                             <div style="text-align:left;margin-left:100px">                                                               
                                     <h2>   Whoops!   </h2>
                                     <p>  No patient on consultation process today    </p>
                              </div>   
                             <div style="text-align:center">
                                 <img alt="" src="../app_resources/imgs/oops.png" style="margin-bottom:10px" />
                             </div>            
          ...
          <div style="padding-top:20px;overflow:scroll">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="border-style:inset;background-color:transparent;margin-top:10px"
                      ...
                      <asp:View ID="View3" runat="server">
                          ...
                          <div id="nodata3" runat="server" visible="false" style="width:98%;margin-top:50px">   
                             <div style="text-align:left;margin-left:100px">                                                               
                                     <h2>   Whoops!   </h2>
                                     <p>  You have not completed any consultation today     </p>
                              </div>   
                             <div style="text-align:center">
                                 <img alt="" src="../app_resources/imgs/oops.png" style="margin-bottom:10px" />
                             </div>            
