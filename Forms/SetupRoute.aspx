<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/admin_master.Master" CodeBehind="SetupRoute.aspx.vb" Inherits="CLOUD_HIMS.SetupRoute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                   ...
                   <table style=" margin-left: 5px;  margin-top: 0px;border-style:outset">
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:TextBox ID="txtroutename" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <div style="width:100%;height:50px">
          <div style="width:30%;float:left;">
               <h2 style="padding-left:20px">ROUTE SETUP</h2>
          </div>
   
          <div  style="float:right;text-align:right;width:68%;" >
                <div  style="float:right;text-align:right;width:68%;" >
              <div style="margin-right:20px;margin-top:5px">
                  <input id="bttnreceive" type="button" value="New Route" class="bttns" onclick="newpatient()"  />&nbsp;&nbsp
                        ...
                        EnableViewState="False" BorderColor="#E7E7FF" DataKeyNames="id"
                           CellPadding="2" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" Width="388px" >
                               ...
                               <Columns> 
                                   ...
                                   <asp:BoundField DataField="colrote"
                                       HeaderText="Route name" SortExpression="colrote" ItemStyle-Width="150" ReadOnly="false">
