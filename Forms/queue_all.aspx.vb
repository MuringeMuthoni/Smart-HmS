                    ...
                    Using Scmd
                        ...
                        Using Mydata
                            While Mydata.Read
                                ...
                                dt.Rows.Add(ids, qno, arrival, names, tel, age, gender, vital)
                    ...
                    Using Scmd
                        ...
                        Using Mydata
                            While Mydata.Read
                                ...
                                dt2.Rows.Add(ids, qno, arrival, names, tel, age, gender)
...
Mwanzo:
                    ...
                    If txttel.Text = "" Then
                        sts = "Select pid,logstime,qno,discharged,vitalstatus,id,names,tel from tbl_queue where status='Discharged' and names like '" & txtnames.Text & "%'"
                    Else
                        sts = "Select pid,logstime,qno,discharged,vitalstatus,id,names,tel from tbl_queue where status='Discharged' and tel = '" & txttel.Text & "'"
                    End If
                    ...
                    Using Scmd
                        ...
                        Using Mydata
                            While Mydata.Read
                                ...
                                dt3.Rows.Add(ids, qno, arrival, names, tel, age, gender, discharged)
    ...
    Protected Sub GridView0_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView0.RowCommand
        ...
        If currentCommand = "view" Then
            Response.Redirect("~/src/Forms/vital_signs.aspx?var1=" & ss)
        End If
