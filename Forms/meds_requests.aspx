<%@ Page Title="" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/pharmacy_master.Master" CodeBehind="meds_requests.aspx.vb" Inherits="CLOUD_HIMS.meds_requests" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="myModal" class="modal"     >                                            
           <div class="modal-content2" style="width:auto;height:500px;margin-right:20px;margin-left:20px">                      
