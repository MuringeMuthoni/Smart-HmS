<%@ Page Title="" EnableEventValidation="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/pharmacy_master.Master" CodeBehind="meds_issued.aspx.vb" Inherits="CLOUD_HIMS.meds_issued" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="myModal"  class="modal"    >                                            
           <div class="modal-content2" style="width:700px;height:500px;">                      
            ...
            CellPadding="7" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal">
                ...
                <Columns> 
                    ...
                    <asp:BoundField DataField="Meds"
                     ...
                     <asp:BoundField DataField="cost"
                        HeaderText="Total Cost" SortExpression="cost"  ReadOnly="true">
                            <ItemStyle Width="150px"  Font-Size="Small" HorizontalAlign="Center" VerticalAlign="Middle"  />
                            </asp:BoundField> 


                               <asp:ButtonField ButtonType="Image"  CommandName="edit"  HeaderText="View details" 
