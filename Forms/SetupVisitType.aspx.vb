Public Class SetupVisitType
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        lblmsg.Text = ""
        If txtclinicnames.Text = "" Then
            lblmsg.Text = "Please enter the Clinic's Name before you proceed."
            Exit Sub
        Else
            lblmsg.Text = ""
        End If
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                Tcmd.CommandText = "select id from tbl_setupvisittype where colvisitname='" & txtclinicnames.Text & "'"
                ...
                Using Mydata
                    If Not Mydata.Read Then
                        ...
                        Tcmd.CommandText = "select count(id) from tbl_setupvisittype" ' where colnames='" & txtnames.Text & "' and colid='" & Txtpatientid.Text & "'"
                        Mydata = Tcmd.ExecuteReader()
                        Using Mydata
                            If Mydata.Read Then
                        ...
                        Using cmd
                            ...
                            cmd.CommandText = "INSERT INTO tbl_setupvisittype" &
                            "(colvisitname,coldescription)" _
                           & "VALUES(?1,?2)"
                            cmd.Parameters.AddWithValue("?1", txtclinicnames.Text)
                            cmd.Parameters.AddWithValue("?2", txtdes.Text)
                            cmd.ExecuteNonQuery()
                        End Using
                    ...
                    Else
                        lblmsg.Text = "Another visit type with same name exists "
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                If txtsnames.Text = "" Then
                    sts = "Select id,colvisitname,coldescription from tbl_setupvisittype "
                Else
                    sts = "Select id,colvisitname,coldescription from tbl_setupvisittype where colvisitname like '%" & txtsnames.Text & "' order by colvisitname desc"
                End If
