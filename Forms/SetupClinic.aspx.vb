    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                Tcmd.CommandText = "select id from tbl_setupclinic where colclinicname='" & txtclinicnames.Text & "'"
                ...
                Using Mydata
                    If Not Mydata.Read Then
                        ...
                        Tcmd.CommandText = "select count(id) from tbl_setupclinic" ' where colnames='" & txtnames.Text & "' and colid='" & Txtpatientid.Text & "'"
                        Mydata = Tcmd.ExecuteReader()
                        Using Mydata
                            If Mydata.Read Then
                        ...
                        Using cmd
                            ...
                            cmd.CommandText = "INSERT INTO tbl_setupclinic" &
                            "(colclinicname,coldescription)" _
                           & "VALUES(?1,?2)"
                    ...
                    Else
                        lblmsg.Text = "Another clinic with same name exists "
        ...
        Try
            ...
            Using Myconn As New MySqlConnection
                ...
                If txtsnames.Text = "" Then
                    sts = "Select id,colclinicname,coldescription from tbl_setupclinic "
                Else
                    sts = "Select id,colclinicname,coldescription from tbl_setupclinic where colclinicname like '%" & txtsnames.Text & "' order by colclinicname desc"
                End If
