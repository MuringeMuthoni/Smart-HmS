<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/admin_master.Master" CodeBehind="SetupWard.aspx.vb" Inherits="CLOUD_HIMS.SetupWard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                   ...
                   <table style=" margin-left: 5px;  margin-top: 0px;border-style:outset">
                                            <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:TextBox ID="txtwnames" runat="server" Width="260px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                               ...
                                               <tr>
                                                ...
                                                <td style="text-align: left; height: 1px;">
                                                    <asp:DropDownList ID="Dpofloor" runat="server"></asp:DropDownList>
                                                       </td>    
                                            </tr>
    ...
    <div style="width:100%;height:50px">
          <div style="width:30%;float:left;">
               <h2 style="padding-left:20px">WARD SETUP</h2>
          </div>
   
          <div  style="float:right;text-align:right;width:68%;" >
                <div  style="float:right;text-align:right;width:68%;" >
              <div style="margin-right:20px;margin-top:5px">
                  <input id="bttnreceive" type="button" value="New Ward" class="bttns" onclick="newpatient()"  />&nbsp;&nbsp
                                ...
                                <table style="border: 1px inset antiquewhite; background-color:silver;width:600px; margin-left: 10px;  margin-top: 0px;">
                                        ...
                                        <tr style="border-style:inset">
                                              ...
                                              <td style="text-align: left; height: 1px;width:160px;">
                                                <asp:TextBox ID="txtsnames" runat="server" Visible="False"></asp:TextBox>
                                                <asp:Button ID="Btnsearch" runat="server" Text="go" style="height: 26px" Visible="False" />
                                                </td>
                        ...
                        EnableViewState="False" BorderColor="#E7E7FF" DataKeyNames="id"
                           CellPadding="6" BackColor="White" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal">
                               ...
                               <Columns> 
                                   ...
                                   <asp:BoundField DataField="colname"
                                       HeaderText=" Name" SortExpression="colname" ItemStyle-Width="150" ReadOnly="false">
