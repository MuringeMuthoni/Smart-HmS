Public Class RtpIncome
        ...
        Try
            ...
            Using Myconn2 As New MySqlConnection
                Using Myconn As New MySqlConnection
                    ...
                    Scmd.CommandText = "select distinct dates from tbl_transaction "
                    ...
                    Using seldata
                        While seldata.Read
                            ...
                            Dim Pno As Int16 = 0
                            Dim Pcost As Int16 = 0
                            cmd = New MySqlCommand
                            cmd.CommandText = "Select count(id),sum(amount) from tbl_transaction where dates like '" & siku & "%'"
    ...
    Protected Sub grdrequest_SelectedIndexChanged(sender As Object, e As EventArgs) Handles grdrequest.SelectedIndexChanged
