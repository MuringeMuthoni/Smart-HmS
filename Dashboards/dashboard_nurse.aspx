<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/Nurse.Master" CodeBehind="dashboard_nurse.aspx.vb" Inherits="CLOUD_HIMS.dashboard_nurse" %>
         ...
         <div style="margin-top:10px;padding-top:10px">
             ...
             <table>
                 <tr>
                     ...
                     <%--<td>
                         <div style="border-style:ridge;width:100px;border-radius:25px;border-width:1px">
                            <asp:ImageButton type="button" onclick="ImageButton1_Click"  ID="ImageButton1" ImageUrl="~/src/app_resources/imgs/inpatient.png" runat="server" Height="100px"     />
                         </div>
                     </td>   --%>                  
