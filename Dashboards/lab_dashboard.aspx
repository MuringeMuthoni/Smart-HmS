<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/src/Master_Forms/lab_master.Master" CodeBehind="lab_dashboard.aspx.vb" Inherits="CLOUD_HIMS.lab_dashboard" %>
                 ...
                 <tr>
                      <td style="border-spacing:15px">
                         <div style="border-style:ridge;width:100px;border-radius:25px;border-width:1px">
                            <asp:ImageButton type="button"  ID="ImageButton8" ImageUrl="~/src/app_resources/imgs/lab_request.png" runat="server" Height="100px"     />
                         </div>
                     </td>
                     <td>
                         <div style="border-style:ridge;width:100px;border-radius:25px;border-width:1px">
                            <asp:ImageButton type="button"  ID="ImageButton1" ImageUrl="~/src/app_resources/imgs/lab_results.png" runat="server" Height="100px"     />
                         </div>
                     </td>                     
