...
Public Class Reception
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Script", "resize();", True)
        End If
    ...
    Private Sub Reception_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
